...
class splitbase():
    def __init__(self,
        ...
        """
        :param basepath: base path for fair1m_test data
        :param outpath: output base path for fair1m_test data,
    ...
    def SplitSingle(self, name, rate, extent):
        ...
        # 这里根据图片名字 检索labelTxt中的label
        # 如果发现图片存在，但是label文件信息不存在，则直接跳过，不处理此图片
        #
...
if __name__ == '__main__':
    split = splitbase(r'data/fair1m_test/train', r'data/dota_train_1024/train_split',
