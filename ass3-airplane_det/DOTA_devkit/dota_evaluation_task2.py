...
def main():
    ...
    # annopath = r'I:\fair1m_test\testset\ReclabelTxt-utf-8\{:s}.txt'
    # imagesetfile = r'I:\fair1m_test\testset\va.txt'

    detpath = r'work_dirs/temp/result_merge/Task2_{:s}.txt'
    annopath = r'data/fair1m_test/test/hbb_label_txt/{:s}.txt'  # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'data/fair1m_test/test/testset.txt'
